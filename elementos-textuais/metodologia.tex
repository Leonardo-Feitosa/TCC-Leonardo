...
\begin{table}[h!]
	\Caption{\label{tabela-mwf}Valores de perda de penetração da parede para o modelo MWF para 5.8 GHz.}%
	\IBGEtab{}{%
		\begin{tabular}{lcc}
			\toprule
			...
			Parede de gesso -- rebocada com 1 mm de gesso & 13.5 cm & $L_{w2I} = 3.0\ dB$ \\
	...
	\Fonte{\citeonline[p. ~465]{lott2001ieee}; \apudonline[p.~73]{lott2001ieee}{geier2002}}%
