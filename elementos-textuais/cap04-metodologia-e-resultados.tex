...
\begin{figure}[H]
	...
	\UECEfig{}{
		\includegraphics[scale=.185]{figuras/APs_Bloco_Andar_2_02.pdf}
	}{
		\Fonte{Autor.}
	}	
\end{figure}
...
\begin{table}[H]
	...
	\IBGEtab{}{%
		\begin{tabular}{cc}
			...
			Taxa de Sinal & 5 GHz: Até 1300 Mbps, 2.4GHz: Até 450 Mbps \\
			...
			Potência de Transmissão & \begin{tabular}[c]{@{}l@{}}CE: <20dBm (2.4 GHz), \textless{}23dBm (5 GHz)\\ 
				FCC: <30dBm (2.4 GHz e 5 GHz)\end{tabular} \\

			\bottomrule
		\end{tabular}%
	}{%
		\Fonte{Adaptado de \citeonline{archerc72019}.}%
...
\begin{figure}[H]
	...
	\UECEfig{}{
		\includegraphics[scale=.26]{figuras/Pontos_Medidos_Andar01.pdf}
	}{
		\Fonte{Autor.}%
	}	
\end{figure}
