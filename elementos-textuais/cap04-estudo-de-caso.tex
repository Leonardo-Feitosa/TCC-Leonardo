...
\section{Infraestrutura da rede sem fio}
...
O ambiente analisado abrange uma área do tipo \textit{indoor} por conter salas, e também \textit{outdoor} devido ao espaço livre no prédio, como os que estão no primeiro andar. \textcolor{blue}{As Figuras \ref{fig:andar1}} e \ref{fig:andar2} mostram alguns dos pontos que foram verificados.
...
\begin{figure}[H]
	...
	\UECEfig{}{
		\includegraphics[scale=.52,angle=90]{figuras/heatmapper_2_andar.png}
	}{
		\Fonte{Autor.}%
	}	
\end{figure}
...
\begin{figure}[H]
	...
	\UECEfig{}{
		\includegraphics[scale=.62,angle=90]{figuras/heatmapper_Terreo_Editada.png}
	}{
		\Fonte{Autor.}%
	}	
\end{figure}
