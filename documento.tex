...
\titulo{Aplicação do Método de Site Survey para Análise de Cobertura e Recepção do Sinal Wi-Fi no Bloco Didático do Instituto Federal do Ceará campus Tauá}
\data{2019}
\local{Tauá -- Ceará}
...
%	\input{elementos-textuais/conclusao}
	...
	\input{elementos-textuais/cap04-estudo-de-caso}
